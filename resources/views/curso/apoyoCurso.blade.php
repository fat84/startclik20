    ...
    <div class="mdk-drawer-layout__content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="subirmaterialdeapoyo_curso">material de apoyo</a></li>
                <li class="breadcrumb-item active">Subir material de apoyo para Cursos</li>
            </ol>

            <div class="media">
                <div class="media-body">
                    <h1 class="page-heading h2">
                        Subir material de apoyo para Cursos
                    </h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <form id="formu" name="formu" action="guardar_materialApoyo_curso" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group col-md-6">
                                    <label for="empresa_id"><b style="color:red;">* </b><b>Curso al que perteneces</b></label>

                                    <select name="curso" class="custom-select form-control">
                                        <option selected disabled>Seleccione una Curso</option>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Material de apoyo de Cursos</h4>
                        </div>
                        <div class="card-block">
                            <div>
                                             ...
                                             <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="material_curso/{{$material_apoyo->id}}/editar">Editar</a>
                                                        <a class="dropdown-item" href="eliminar_material_curso/{{$material_apoyo->id}}">Eliminar</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
