...
@section('content')
    ...
    @endif
    <div class="element-wrapper"><h6 class="element-header">Crear administrador</h6>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group xs-pt-10">
                        ...
                        <input type="text" placeholder="Numero documento" name="documento"
                               value="{{ old('documento') }}" class="form-control">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group xs-pt-10">
                        ...
                        <input type="text" placeholder="Telefono"
                               value="{{ old('telefono1') }}" name="telefono"
                               class="form-control">
                    </div>
                    <div class="form-group xs-pt-10">
                    ...
                    <button type="submit" class="btn btn-primary btn-space">Crear
                        Administrador
                    </button>
                </div>
                <div>
    ...
    <div class="element-wrapper"><h6 class="element-header">Lista de administradores</h6>
        <div class="element-box">
                ...
                <table id="dataTable2" class="table table-striped table-lightfont" cellspacing="0" width="100%">
                    ...
                    @foreach($administradores as $administrador)
                        <tr>
                            ...
                            <td>
                                {!! link_to_route('administrador.edit', $title = 'Editar', $parameters = $administrador->id, $attributes = ['class'=>'btn btn-primary block']) !!}
                                <br><br>
