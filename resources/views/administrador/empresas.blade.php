                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group xs-pt-10">
                                            ...
                                            <input type="text" placeholder="Nombre" name="razon_social" class="form-control" value="{{ old('name') }}" >
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-space">Crear Empresa</button>
                                    </div>
                                    <div>
                                        <div></div>
                                    </div>
                            ...
                            <div class="card-block">
                                <div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="dataTable2" class="table table-striped table-lightfont" cellspacing="0" width="100%">   <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Creado</th>
                                            <th>Nombre</th>
                                        ...
                                        @foreach($empresas as $empresa)
                                            <tr>
                                                ...
                                                <td>
                                                    {!! link_to_route('empresa.edit', $title = 'Editar', $parameters = $empresa->id, $attributes = ['class'=>'btn btn-primary block']) !!}
                                                    <br><br>
